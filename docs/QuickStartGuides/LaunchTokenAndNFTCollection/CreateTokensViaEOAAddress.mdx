...
Regular users can only create tokens/NFT collections through the [sales contract](/docs/EnvironmentalConfiguration).

Users enter the desired symbol, and the sales contract first mints a [721-type NFT](/docs/EnvironmentalConfiguration) containing this symbol's information. Subsequently, the [MultiToken](/docs/EnvironmentalConfiguration) contract is called through this NFT to create the symbol.
