...
<div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'start', width: '100%'}}>
  <img src='/img/ui-sdk/asset-token-mainnet.png' width={'32%'} style={{padding: 20, border: '1px solid #dee2e8'}} />
  <img src='/img/ui-sdk/asset-nft-mainnet.png' width={'32%'} style={{padding: 20, border: '1px solid #dee2e8'}} />
  <img src='/img/ui-sdk/asset-activity-mainnet.png' width={'32%'} style={{padding: 20, border: '1px solid #dee2e8'}} />
</div>
...
<div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'start', width: '100%'}}>
  <img src='/img/ui-sdk/asset-token-testnet.png' width={'32%'} style={{padding: 20, border: '1px solid #dee2e8'}} />
  <img src='/img/ui-sdk/asset-nft-testnet.png' width={'32%'} style={{padding: 20, border: '1px solid #dee2e8'}} />
  <img src='/img/ui-sdk/asset-activity-testnet.png' width={'32%'} style={{padding: 20, border: '1px solid #dee2e8'}} />
</div>
